...
import com.tutorialsnija.qa.Utilities.ExtentReporter;
...
public class MyListeners implements ITestListener {
	...
	@Override
	public void onStart(ITestContext context) {//ITestContext its another interface- related to the project
	...
	@Override
	public void onTestStart(ITestResult result) {//ITestResult  another interface- related to the test
	...
	@Override
	public void onTestFailure(ITestResult result) {//this code copy code, noone remember this code
		testName = result.getName();
		driver = null;
		try {
		...
		//System.out.println(testName + "--------> Executon Failed");
